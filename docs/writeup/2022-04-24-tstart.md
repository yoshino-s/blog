...
![验证码](https://cdn.yoshino-s.xyz/typora_img/image-20220420211837215.png)
...
![xml报错](https://cdn.yoshino-s.xyz/typora_img/image-20220422153806186.png)

![谷歌](https://cdn.yoshino-s.xyz/typora_img/image-20220422153838130.png)
...
![参考](https://cdn.yoshino-s.xyz/typora_img/image-20220420212137905.png)

![xxe成功](https://cdn.yoshino-s.xyz/typora_img/image-20220420211942320.png)
...
![github](https://cdn.yoshino-s.xyz/typora_img/image-20220420212619466.png)

![微博](https://cdn.yoshino-s.xyz/typora_img/image-20220420212555933.png)

看微博

![ip归属地](https://cdn.yoshino-s.xyz/typora_img/image-20220420214514527.png)
...
![wireshark](https://cdn.yoshino-s.xyz/typora_img/image-20220420213018163.png)

`tcp.stream eq 3`一段shell交互

![shell](https://cdn.yoshino-s.xyz/typora_img/image-20220422154225326.png)

![解包](https://cdn.yoshino-s.xyz/typora_img/image-20220422155528241.png)

![解压缩](https://cdn.yoshino-s.xyz/typora_img/image-20220422155610740.png)

cyberchef用`private_key.pem`解一下`key.en`，得到

![cyberchef](https://cdn.yoshino-s.xyz/typora_img/image-20220422155711253.png)
...
![二维码](https://cdn.yoshino-s.xyz/typora_img/image-20220422160526900.png)
...
![爆破](https://cdn.yoshino-s.xyz/typora_img/image-20220422160904911.png)
...
![二维码（修复完成](https://cdn.yoshino-s.xyz/typora_img/image-20220422161458086.png)

`我真是一个压缩包.zip`改一下头 `504B`

![文件头](https://cdn.yoshino-s.xyz/typora_img/image-20220422161601604.png)

解压出一个MP3，莫斯，

![莫斯解码](https://cdn.yoshino-s.xyz/typora_img/image-20220422165716510.png)

![解压结果](https://cdn.yoshino-s.xyz/typora_img/image-20220422161844731.png)

## 不眠之夜

测一下注入

![报错](https://cdn.yoshino-s.xyz/typora_img/image-20220422162130852.png)

`strconv.ParseInt`显然就是go，go基本没啥洞，逻辑或者溢出

-1试一下不行，那就找个最贵的买，1个不行，100个库存不够，二分法找一下，最后发现34

![负数不行](https://cdn.yoshino-s.xyz/typora_img/image-20220422162341928.png)

![库存不够](https://cdn.yoshino-s.xyz/typora_img/image-20220422162354461.png)

![够了](https://cdn.yoshino-s.xyz/typora_img/image-20220422162423538.png)

然后就随便买了

![买了好多](https://cdn.yoshino-s.xyz/typora_img/image-20220422162456756.png)

其他没啥用，除了葫芦娃就是葫芦娃。

![微信公众号](https://cdn.yoshino-s.xyz/typora_img/image-20220422162529589.png)

（才发现微博上居然有密码

![微博上的](https://cdn.yoshino-s.xyz/typora_img/image-20220422162600389.png)
...
![文章](https://cdn.yoshino-s.xyz/typora_img/image-20220422162857821.png)
...
![outguess](https://cdn.yoshino-s.xyz/typora_img/image-20220422164203851.png)
...
![index.php](https://cdn.yoshino-s.xyz/typora_img/image-20220422164438363.png)

手动fuzz到一个

![flag.php](https://cdn.yoshino-s.xyz/typora_img/image-20220422164424968.png)

显然就是直接ssrf去打

![Flag](https://cdn.yoshino-s.xyz/typora_img/image-20220422164510346.png)